...
@section('page_title', __('label.add_upcoming_video'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('label.add_upcoming_video')}}</h1>
            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.add_upcoming_video')}}</li>
                    </ol>
                </div>
                ...
                <div class="custom-border-card">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="{{__('label.enter_movies_name')}}" autofocus>
                            </div>
                        </div>
                    </div>
                    @elseif ($status == 1)
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <input type="text" name="name" id="Tmdb_name" list="Tmdb_name_list" class="form-control" placeholder="{{__('label.enter_movies_name')}}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-4">
                            ...
                            <select name="subtitle_type" id="subtitle_type" class="form-control">
                                <option selected value="server_video">{{__('label.server_video')}}</option>
                                <option value="external">{{__('label.external_url')}}</option>
                            </select>
                        </div>
                    </div>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_video', '{{ route("upcomingvideo.index") }}');
                    },
