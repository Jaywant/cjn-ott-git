            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pch_video.index') }}">{{__('label.videos')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.video_details')}}</li>
                    </ol>
                </div>
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('pch_video.index') }}" class="btn btn-default mw-150" style="margin-top: -14px;">{{__('label.video_list')}}</a>
                </div>
            </div>
