...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <!-- Search -->
            <form action="{{ route('pkidsvideo.index')}}" method="GET">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-xl-3" title="{{__('label.add_video')}}">
                    <a href="{{ route('pkidsvideo.create') }}" class="add-video-btn">
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('pkidsvideo.details', [$value->id])}}" title="{{__('label.statistics')}}">
                                        <i class="fa-solid fa-chart-line fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('pkidsvideo.edit', [$value->id])}}" title="{{__('label.edit')}}">
                                        <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('pkidsvideo.show', [$value->id])}}" title="{{__('label.delete')}}" onclick="return confirm('{{__('label.delete_video')}}')">
