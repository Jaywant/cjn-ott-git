...
@section('page_title', __('label.add_upcoming_tv_show'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('label.add_upcoming_tv_show')}}</h1>
            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.add_upcoming_tv_show')}}</li>
                    </ol>
                </div>
	...
	<script>
		function save_tvshow() {
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("pupcomingtvshow.store") }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_tvshow', '{{ route("pupcomingtvshow.index") }}');
                    },
