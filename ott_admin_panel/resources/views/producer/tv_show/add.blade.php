...
@section('page_title', __('label.add_tv_show'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('label.add_tv_show')}}</h1>
            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.add_tv_show')}}</li>
                    </ol>
                </div>
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('ptvshow.index') }}" class="btn btn-default mw-120" style="margin-top:-14px">{{__('label.tv_shows')}}</a>
                </div>
            </div>
            ...
            <form id="save_tvshow" enctype="multipart/form-data">
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('ptvshow.index')}}" class="btn btn-cancel mw-120 ml-2">{{__('label.cancel')}}</a>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_tvshow', '{{ route("ptvshow.index") }}');
                    },
