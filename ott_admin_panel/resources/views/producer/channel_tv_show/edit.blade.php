    ...
    <script>
        function edit_TVShow() {
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("pch_tvshow.update", [$result->id])}}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'edit_TVShow', '{{ route("pch_tvshow.index") }}');
                    },
        ...
        $(document).ready(function() {
            ...
            $("#language_id").select2({placeholder: "Select Language"});
            $("#cast_id").select2({placeholder: "Select Cast"});
