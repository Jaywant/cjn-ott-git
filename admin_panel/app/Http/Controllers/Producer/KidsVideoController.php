...
class KidsVideoController extends Controller
{
        ...
        try {
            ...
            if ($input_search != null && isset($input_search)) {
                ...
                if ($input_type != 0 && $input_rent == 0) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('name', 'LIKE', "%{$input_search}%")->where('video_type', 7)->where('type_id', $input_type)
                        ->with('type')->orderBy('id', 'desc')->paginate(15);
                } else if ($input_type != 0 && $input_rent == 1) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('name', 'LIKE', "%{$input_search}%")->where('video_type', 7)->where('type_id', $input_type)->where('is_rent', 1)
                        ->with('type')->orderBy('id', 'desc')->paginate(15);
                } else if ($input_type == 0 && $input_rent == 1) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('name', 'LIKE', "%{$input_search}%")->where('video_type', 7)->with('type')->where('is_rent', 1)->orderBy('id', 'desc')->paginate(15);
                } else {
                    $video_list = Video::where('producer_id', $producer['id'])->where('name', 'LIKE', "%{$input_search}%")->where('video_type', 7)->with('type')->orderBy('id', 'desc')->paginate(15);
                }
            } else {

                if ($input_type != 0 && $input_rent == 0) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('video_type', 7)->where('type_id', $input_type)->with('type')->orderBy('id', 'desc')->paginate(15);
                } else if ($input_type != 0 && $input_rent == 1) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('video_type', 7)->where('type_id', $input_type)->where('is_rent', 1)->with('type')->orderBy('id', 'desc')->paginate(15);
                } else if ($input_type == 0 && $input_rent == 1) {
                    $video_list = Video::where('producer_id', $producer['id'])->where('video_type', 7)->with('type')->where('is_rent', 1)->orderBy('id', 'desc')->paginate(15);
                } else {
                    $video_list = Video::where('producer_id', $producer['id'])->where('video_type', 7)->with('type')->orderBy('id', 'desc')->paginate(15);
                }
            }
            ...
            return view('producer.kids_video.index', ['result' => $video_list, 'type' => $type]);
        } catch (Exception $e) {
    ...
    public function create()
    {
        try {
            ...
            return view('producer.kids_video.add', $params);
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('producer.kids_video.edit', $params);
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            if ($video->delete()) {
                ...
                return redirect()->route('pkidsvideo.index')->with('success', __('label.controller.data_delete_successfully'));
            }
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
    ...
    public function kidsVideoDetails($id)
    {
        try {
            ...
            return view('producer.kids_video.details', $params);
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
    }
