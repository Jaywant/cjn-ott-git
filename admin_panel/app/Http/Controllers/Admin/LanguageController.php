...
class LanguageController extends Controller
{
            ...
            if ($request->ajax()) {
                ...
                return DataTables()::of($data)
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        $delete = ' <form onsubmit="return confirm(\'' . $language_delete . '\');" method="POST"  action="' . route('language.destroy', [$row->id]) . '">
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('language.index')->with('success', __('label.controller.data_delete_successfully'));
        } catch (Exception $e) {
            return response()->json(array('status' => 400, 'errors' => $e->getMessage()));
        }
    }
